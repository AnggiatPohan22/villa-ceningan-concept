    ...
    <section className="home2-about" id="home-about" aria-labelledby="home-about-title">
      <div className="home2-about__media">
        <Image
          ...
          alt={`${property.name} private terrace and outdoor bath atmosphere`}
          fill
      ...
      <div className="home2-about__content">
        ...
        <h2 id="home-about-title">A best place to enjoy your life</h2>
        <p>
          Set on the calm side of Nusa Ceningan, Villa Ceningan brings together
          warm island hospitality, quiet interiors, and the simple luxury of
          waking close to the water.
        </p>
